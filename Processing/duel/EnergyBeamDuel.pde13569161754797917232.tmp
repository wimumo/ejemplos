...
“Energy Beam Duel” 
by David King
http://openprocessing.org/sketch/153003
License CreativeCommons Attribution ShareAlike
https://creativecommons.org/licenses/by-sa/3.0

Recibe OSCs directamente de WIMUMO

*/


// Variables para wimumo
import oscP5.*;
OscP5 oscP5;
float w1=0;
float w2=0;
...
String nombre_wimumo = "/wimumo025"; // Cambiar según su WIMUMO
...
void disparo1_up(){
  // Modificado para disparar con wimumo
  //player 1
  if(p1.allowed[0]){
    p1.input[0] = true;
    p1.allowed[0] = false;
...
enum dispe {reposo, cruce_alto, cruce_bajo }
dispe estado1 = dispe.reposo;
dispe estado2 = dispe.reposo;
...
void oscEvent(OscMessage theOscMessage) {
  if (theOscMessage.checkAddrPattern(nombre_wimumo+"/env/ch1")==true) {
    ...
    if (w1>umbral_dis && estado1 == dispe.reposo) {
      estado1 = dispe.cruce_alto;
      disparo1_up();
      print("1u");
    }
    else if (estado1 == dispe.cruce_alto && w1<umbral_pre) {
      estado1 = dispe.cruce_bajo;
      disparo1_down();
      print("1d");
    }
    else if (estado1 == dispe.cruce_bajo && w1<umbral_pre) {
      estado1 = dispe.reposo;
      print("1r");
    }
  ...
  if (theOscMessage.checkAddrPattern(nombre_wimumo+"/env/ch2")==true) {
    ...
    //println(w2);
     ...
     if (w2>umbral_dis && estado2 == dispe.reposo) {
      estado2 = dispe.cruce_alto;
      disparo2_up();
      print("2u");
    }
    else if (estado2 == dispe.cruce_alto && w2<umbral_pre) {
      estado2 = dispe.cruce_bajo;
      disparo2_down();
      print("2d");
    }
    else if (estado2 == dispe.cruce_bajo && w2<umbral_pre) {
      estado2 = dispe.reposo;
      print("2r");
    }
